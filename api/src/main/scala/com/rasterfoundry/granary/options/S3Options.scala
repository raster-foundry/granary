...
trait S3Options {
  ...
  private val dataBucket: Opts[NonEmptyString] =
    Opts.option[NonEmptyString]("data-bucket", help = dataBucketHelp) orElse Opts
      .env[NonEmptyString]("GRANARY_DATA_BUCKET", help = dataBucketHelp) withDefault (refineMV(
